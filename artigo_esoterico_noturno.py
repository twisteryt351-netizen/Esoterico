...
TEMAS_ESOTERICOS = [
    ...
    "a invocação dos Guardiões das Torres (Elementais: Gnomos, Ondinas, Salamandras e Silfos)",
    "o papel das plantas, ervas e cristais na magia natural (fitoterapia mágica)",
    "a operação de Abramelin e o ritual para obter o conhecimento e conversação do Anjo da Guarda",
    "o sistema enoquiano de John Dee: as 19 Chaves ou Chamadas e a língua angelical",
    "a diferença entre invocação (trazer o divino para dentro) e evocação (trazer o espírito para fora)",
    "o conceito de Santo Anjo da Guarda (HGA) na magia cerimonial e sua importância prática",
    "a magia dos talismãs: como confeccionar, consagrar e ativar um talismã planetário",
    "as horas planetárias e sua aplicação em rituais mágicos para cada dia da semana",
    "a geometria sagrada: o significado do cubo de Metatron e da Flor da Vida na criação",
    "os mistérios de Mitra e seu culto secreto no Império Romano com rituais em grutas",
    "a tradição druídica e o papel dos carvalhos, do visgo e do ciclo das estações nos festivais celtas",
    "o xamanismo siberiano e o uso do cogumelo Amanita muscaria em rituais de transe e cura",
    "a magia dos cristais e pedras: propriedades do quartzo, ametista, obsidiana e selenita",
    "a interpretação dos sonhos na tradição ocultista e o conceito de sonhos lúcidos como portal mágico",
    "o culto de Santa Morte (Santa Muerte) como sincretismo entre crenças indígenas e católicas",
    "a magia do caos: a técnica do 'servidor' (servitor) e como criar uma entidade artificial consciente",
    "a doutrina gnóstica: o Demiurgo, a Sophia e a centelha divina aprisionada na matéria",
    "o sufismo islâmico e sua vertente esotérica: a dança dos dervixes e a união com o Divino",
    "a astrologia eletiva: como escolher o momento certo para iniciar um projeto, casamento ou viagem",
    "a magia sexual no Tantra e na O.T.O.: o conceito de energia Kundalini e orgasmo mágico",
    "os manuscritos de Nag Hammadi e a visão gnóstica sobre Jesus como mestre iniciático",
    "a lenda de Atlantis e sua suposta influência nas tradições hermética, egípcia e maçônica",
    "o banimento ritualístico: o Pequeno Ritual do Pentagrama (LBRP) e sua função protetora",
    "o uso do incenso, das velas e das cores na magia simpática e suas correspondências",
    "a doutrina dos Sete Raios e sua relação com os arquétipos planetários e os mestres ascensionados",
    "a magia dos espelhos: espelhos negros para escrying (vidência) e sua história na era vitoriana"
]
